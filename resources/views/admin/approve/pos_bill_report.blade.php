                                                    ...
                                                    <table id="tableId" style=" border-collapse: collapse;" class="table  customers ">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="width: 10%;  border: 1px solid #ddd;">Description Of Goods</th>
                                                                ...
                                                                <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Discount</th>
                                                        ...
                                                        <tbody class="qw" id="myTable">
                                                            ...
                                                            @php $total_qty=0;$amount=0; $total_disc=0; $final_total_credit_product_wise=0; $final_total_debit_product_wise=0; @endphp
                                                            @foreach ($stock_out as $key=>$data)
                                                            @php $total_qty+=$data->qty;$amount+=$data->total; $total_disc+=$data->disc; @endphp
                                                            @php
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 10%;  border: 1px solid #ddd;">{{$data->product_name}}</td>
                                                                ...
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right;">{{number_format((float)$data->disc)}} %</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 10%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">TOTAL :</td>
                                                            ...
                                                            <tr>
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd;"></td>
                                                                <td style="width: 10%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">Net Payable :</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">
                                                            ...
                                                            <tr>
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd;"></td>
                                                                <td style="width: 10%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">Received Amount :</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">
                                                                </td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)$tran_ledger->received_amount, company()->amount_decimals)}}</td>

                                                            </tr>
                                                            <tr>
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd;"></td>
                                                                <td style="width: 10%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">Change Amount :</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">
                                                                </td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)($amount-$tran_ledger->received_amount), company()->amount_decimals)}}</td>
