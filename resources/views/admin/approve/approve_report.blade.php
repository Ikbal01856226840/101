                                            ...
                                            <div class="card-block table_content">
                                                ...
                                                <div class="row col-md-10 row_style m-1">
                                                    <div class="col-md-6 box">
                                                        ...
                                                        @if($tran_ledger->voucher_type_id==19&&$access_report->id_report==151)
                                                        <div style="display:flex;">
                                                            <span style="min-width:130px">Gate Pass Ref</span>
                                                            <span style="margin-right: 3px ">: </span>
                                                            <span style="margin-left:1%"> {{$tran_ledger->gprf??''}}</span>
                                                        </div>
                                                        @endif
                                                        @if($tran_ledger->voucher_type_id==22)
                                                        <div style="display:flex;">
                                                            <span style="min-width:130px">Destination Godown</span>
                                                            <span style="margin-right: 3px ">: </span>
                                                ...
                                                <div class="dt-responsive table-responsive cell-border sd ">
                                                    <table id="tableId" style=" border-collapse: collapse;" class="table  customers ">
                                                        @if((int)$tran_ledger->voucher_type_id==14 OR (int)$tran_ledger->voucher_type_id==8 OR (int)$tran_ledger->voucher_type_id==1 OR (int)$tran_ledger->voucher_type_id==6)
                                                        <thead>
                                                            <tr>
                                                                <th style="width: 1%;  border: 1px solid #ddd;">Serial No</th>
                                                                <th style="width: 1%;  border: 1px solid #ddd;">Type</th>
                                                                <th style="width: 6%;  border: 1px solid #ddd;">Particular</th>
                                                                <th style="width: 3%;  border: 1px solid #ddd;text-align: right">Debit</th>
                                                                <th style="width: 3%;  border: 1px solid #ddd;text-align: right">Credit</th>

                                                                @if (!empty($voucher_type->remark_is))
                                                                    <th style="width: 2%;  border: 1px solid #ddd;text-align:center" class="text-left">Remarks</th>
                                                                @endif
                                                            </tr>
                                                        </thead>
                                                        <tbody class="qw" id="myTable">
                                                            ...
                                                            <tr>
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd; text-align:center">{{ $key+1 }}</td>

                                                                <td style="width: 1%;  border: 1px solid #ddd;">{{$data->dr_cr}}</td>
                                                                <td style="width: 6%;  border: 1px solid #ddd;">{{$data->ledger_name}}</td>
                                                                ...
                                                                @if (!empty($voucher_type->remark_is))
                                                                  <td  style="width: 2%;  border: 1px solid #ddd;">{{$data->remark??''}}</td>
                                                                @endif
                                                            </tr>
                                                            @endforeach
                                                            <tr>
                                                                ...
                                                                <td style="width: 1%;  border: 1px solid #ddd;font-weight: bold;"></td>
                                                        ...
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                <th style="width: 1%;  border: 1px solid #ddd;">Serial No</th>
                                                                <th style="width: 2%;  border: 1px solid #ddd;">Source Godown</th>
                                                                <th style="width: 6%;  border: 1px solid #ddd;">Description Of Goods</th>
                                                                <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Quantity</th>
                                                                <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Rate</th>
                                                                <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Amount</th>
                                                                @if (!empty($voucher_type->remark_is))
                                                                    <th style="width: 2%;  border: 1px solid #ddd;text-align:center" class="text-left">Remarks</th>
                                                                @endif
                                                            </tr>
                                                        ...
                                                        <tbody class="qw" id="myTable">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 2%;  border: 1px solid #ddd;">{{$data->godown_name}}</td>
                                                                <td style="width: 8%;  border: 1px solid #ddd;">{{$data->product_name}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right">{{$data->qty ." "}}{{$data->symbol }}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right">{{number_format((float)$data->rate, company()->amount_decimals)}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right">{{number_format((float)$data->total, company()->amount_decimals)}}</td>
                                                                @if (!empty($voucher_type->remark_is))
                                                                    <td  style="width: 2%;  border: 1px solid #ddd;">{{$data->remark??''}}</td>
                                                                @endif
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;"></td>
                                                                <td style="width: 8%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">TOTAL :</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right">{{$total_out_qty}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right">{{number_format((float)$total_out_rate, company()->amount_decimals)}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right">{{number_format((float)$amount_out, company()->amount_decimals)}}</td>
                                                                @if (!empty($voucher_type->remark_is))
                                                                    <td style="width: 2%;  border: 1px solid #ddd;text-align: right"></td>
                                                                @endif
                                                            </tr>
                                                        ...
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                <th style="width: 1%;  border: 1px solid #ddd;">Serial No</th>
                                                                <th style="width: 2%;  border: 1px solid #ddd;">Source Godown</th>
                                                                <th style="width: 8%;  border: 1px solid #ddd;">Description Of Goods</th>
                                                                <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Quantity</th>
                                                                <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Rate</th>
                                                                <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Amount</th>
                                                                @if (!empty($voucher_type->remark_is))
                                                        ...
                                                        <tbody class="qw" id="myTable">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 2%;  border: 1px solid #ddd;"></td>
                                                                <td style="width: 8%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">TOTAL :</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right">{{$total_in_qty}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right">{{number_format((float)$total_in_rate, company()->amount_decimals)}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right">{{number_format((float)$amount_in, company()->amount_decimals)}}</td>
                                                                @if (!empty($voucher_type->remark_is))
                                                                    <td style="width: 2%;  border: 1px solid #ddd;text-align: right"></td>
                                                                @endif
                                                            </tr>
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="width: 2%;  border: 1px solid #ddd;">Source Godown</th>
                                                                    @endif
                                                                    <th style="width: 8%;  border: 1px solid #ddd;text-align:left">Description Of Goods</th>
                                                                    <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Quantity</th>
                                                                    <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Rate</th>
                                                                    <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Amount</th>
                                                                    @if($tran_ledger->commission_is==1)
                                                                    <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Comm</th>
                                                                    <th style="width: 2%;  border: 1px solid #ddd;text-align: right">Comm Amount</th>
                                                                    @endif
                                                                    @if (!empty($voucher_type->remark_is))
                                                                        <th style="width: 2%;  border: 1px solid #ddd;text-align:center" class="text-left">Remarks</th>
                                                                    @endif
                                                        ...
                                                        @endphp
                                                            ...
                                                            <tr>
                                                                ...
                                                                @endif
                                                                <td style="width: 8%;  border: 1px solid #ddd;">{{$data->product_name}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right;">{{abs($data->qty)." "}}{{$data->symbol }}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right;">{{number_format((float)abs($data->rate), company()->amount_decimals)}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right;">{{number_format((float)abs($data->total), company()->amount_decimals)}}</td>

                                                                @if($tran_ledger->commission_is==1)
                                                                    <td style="width: 2%;  border: 1px solid #ddd;text-align: right;">{{($data->commission_commission_type==1?'(-)%':($data->commission_commission_type==3?'(-)':($data->commission_commission_type==2?'(+)%':'(+)')))}}{{" ". ($data->commission_commission??0) }}</td>
                                                                    @if($data->commission_commission_type==2||$data->commission_commission_type==4)
                                                                        ...
                                                                        <td style="width: 2%;  border: 1px solid #ddd;text-align: right;">{{number_format((float)($data->commission_credit??0), company()->amount_decimals)}}</td>
                                                                    @endif
                                                                    @if($data->commission_commission_type==1||$data->commission_commission_type==3)
                                                                        ...
                                                                        <td style="width: 2%;  border: 1px solid #ddd;text-align: right; ">{{number_format((float)($data->commission_debit??0), company()->amount_decimals)}}</td>
                                                                    @endif
                                                                @endif
                                                                @if (!empty($voucher_type->remark_is))
                                                                  <td  style="width: 2%;  border: 1px solid #ddd;">{{$data->remark??''}}</td>
                                                            ...
                                                            @endforeach
                                                            <tr>
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">TOTAL:</td>
                                                                {{-- @if($tran_ledger->voucher_type_id==22)
                                                                <td style="width: 2%;  border: 1px solid #ddd;"></td>
                                                                @endif --}}
                                                                {{-- <td style="width: 8%;  border: 1px solid #ddd;font-weight: bold;text-align: right;"></td> --}}
                                                                <td colspan="{{ $tran_ledger->voucher_type_id==22?3:2 }}" style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">
                                                                ...
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)$total_rate, company()->amount_decimals)}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)$amount, company()->amount_decimals)}}</td>
                                                                @if($tran_ledger->commission_is==1)
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">{{number_format((float)abs($final_total_credit_product_wise-$final_total_debit_product_wise), company()->amount_decimals)}}</td>
                                                                @endif
                                                                @if (!empty($voucher_type->remark_is))
                                                                    <td style="width: 2%;  border: 1px solid #ddd;text-align: right"></td>
                                                                @endif
                                                            ...
                                                            @if($tran_ledger->commission_is==1)
                                                            <tr>
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">Commission Total:</td>
                                                                {{-- <td style="width: 8%;  border: 1px solid #ddd;font-weight: bold;bold;text-align: right;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;"></td> --}}
                                                                <td colspan="4" style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)abs($final_total_credit_product_wise-$final_total_debit_product_wise), company()->amount_decimals)}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right;"></td>
                                                                @if (!empty($voucher_type->remark_is))
                                                                    <td style="width: 2%;  border: 1px solid #ddd;text-align: right"></td>
                                                                @endif
                                                            </tr>
                                                            ...
                                                            @if($tran_ledger->commission_is==1)
                                                            <tr>
                                                                @php $total_without_commission= (($amount)-($final_total_debit_product_wise-$final_total_credit_product_wise)) @endphp
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd; font-weight: bold;text-align: right;">Net Total:</td>
                                                                {{-- <td style="width: 8%;  border: 1px solid #ddd;font-weight: bold;bold;text-align: right;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;"></td> --}}
                                                                <td colspan="4" style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)abs(($amount)-($final_total_debit_product_wise-$final_total_credit_product_wise)), company()->amount_decimals)}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right;"></td>
                                                                @if (!empty($voucher_type->remark_is))
                                                                    <td style="width: 2%;  border: 1px solid #ddd;text-align: right"></td>
                                                            ...
                                                            <tr>
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd;font-weight: bold;bold;text-align: right;">Commission</td>
                                                                {{-- @if($tran_ledger->voucher_type_id==22)
                                                                <td style="width: 2%;  border: 1px solid #ddd;"></td>
                                                                @endif

                                                                <td style="width: 8%;  border: 1px solid #ddd;"></td> --}}

                                                                <td colspan="{{$tran_ledger->voucher_type_id==22?3:2}}" style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{$data->commission_type==1?'(-)%':($data->commission_type==3?'(-)':($data->commission_type==2?'(+)%':'(+)')) }} </td>
                                                                <td  style="width: 2%;  border: 1px solid #ddd;;text-align: right;">{{$data->commission}}</td>
                                                                @if($tran_ledger->voucher_type_id==25)
                                                                    @if($data->commission_type==1||$data->commission_type==3)
                                                                        @php $final_total_credit+=($data->credit) @endphp
                                                                        <td  style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)$data->credit, company()->amount_decimals)}}</td>
                                                                    @endif
                                                                    @if($data->commission_type==2||$data->commission_type==4)
                                                                        @php $final_total_debit+=($data->debit) @endphp
                                                                        <td  style="width: 2%;  border: 1px solid #ddd; font-weight: bold;;text-align: right;">{{number_format((float)$data->debit, company()->amount_decimals)}}</td>
                                                                    @endif
                                                                @else
                                                                    @if($data->commission_type==2||$data->commission_type==4)
                                                                    @php $final_total_credit+=($data->credit) @endphp
                                                            ...
                                                            @endforeach
                                                            <tr>
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd; font-weight: bold;bold;text-align: right;">Final Total:</td>
                                                                ...
                                                                <td style="width: 2%;  border: 1px solid #ddd;"></td> --}}
                                                                @if($tran_ledger->commission_is==1)
                                                                <td colspan="{{ $tran_ledger->voucher_type_id==22?5:4 }}" style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)abs($total_without_commission-(($final_total_debit-$final_total_credit))), company()->amount_decimals)}}</td>
                                                                @else
                                                                  @if($tran_ledger->voucher_type_id==25)
                                                                    <td colspan="{{ $tran_ledger->voucher_type_id==22?5:4 }}" style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)abs($amount-($final_total_credit-$final_total_debit)), company()->amount_decimals)}}</td>
                                                                  @else
                                                                   <td colspan="{{ $tran_ledger->voucher_type_id==22?5:4 }}" style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)abs($amount-($final_total_debit-$final_total_credit)), company()->amount_decimals)}}</td>
                                                                  @endif
                                                                @endif
                                                                @if($tran_ledger->commission_is==1)
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right;"></td>
