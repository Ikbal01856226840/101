                                                ...
                                                <div class="dt-responsive table-responsive cell-border sd ">
                                                    <table id="tableId" style=" border-collapse: collapse;" class="table  customers ">
                                                        ...
                                                        <tbody class="qw" id="myTable">
                                                            ...
                                                            <tr>
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd;"></td>
                                                                <td style="width: 8%;  border: 1px solid #ddd;font-weight: bold;bold;text-align: right;">Commission Total :</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="sl" style="width: 1%;  border: 1px solid #ddd;"></td>
                                                                <td style="width: 8%;  border: 1px solid #ddd;font-weight: bold;bold;text-align: right;">Net Total : </td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)abs(($amount)-($final_total_debit_product_wise-$final_total_credit_product_wise)), company()->amount_decimals)}}</td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;text-align: right;"></td>
                                                            </tr>
                                                            @endif
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 8%;  border: 1px solid #ddd;font-weight: bold;bold;text-align: right;">Commission</td>

                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{$data->commission_type==1?'(-)%':($data->commission_type==3?'(-)':($data->commission_type==2?'(+)%':'(+)')) }} </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 2%;  border: 1px solid #ddd;"></td>
                                                                @endif
                                                                <td style="width: 8%;  border: 1px solid #ddd;font-weight: bold;text-align: right;">Final Total :</td>

                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;"></td>
                                                                <td style="width: 2%;  border: 1px solid #ddd;"></td>
                                                                @if($tran_ledger->commission_is==1)
                                                                <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)abs($total_without_commission-(($final_total_debit-$final_total_credit))), company()->amount_decimals)}}</td>
                                                                @else
                                                                  @if($tran_ledger->voucher_type_id==25)
                                                                    <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)abs($amount-($final_total_credit-$final_total_debit)), company()->amount_decimals)}}</td>
                                                                  @else
                                                                   <td style="width: 2%;  border: 1px solid #ddd;font-weight: bold;;text-align: right;">{{number_format((float)abs($amount-($final_total_debit-$final_total_credit)), company()->amount_decimals)}}</td>
                                                                  @endif
                                                                @endif
                                                                @if($tran_ledger->commission_is==1)
                                                                <td style="width: 2%;  border: 1px solid #ddd;text-align: right;"></td>
