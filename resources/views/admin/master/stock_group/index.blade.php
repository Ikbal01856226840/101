    ...
    $("#edit_stock_group_form").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data, status, xhr) {
                ...
                $(".group_id").val(0).trigger('change');
                $(".sales_ledger").val(0).trigger('change');
...
function edit_group_chart(id) {
    $.ajax({
        ...
        success: function(response) {
            ...
            $(".sales_ledger").val(response.data.sales_ledger).trigger('change');
            $(".purchase_ledger").val(response.data.purchase_ledger).trigger('change');
