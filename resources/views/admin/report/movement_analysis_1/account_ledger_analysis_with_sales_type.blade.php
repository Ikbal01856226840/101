...
@section('title','Accounts Ledger Analysis With Sales Type')
@push('css')
<style>
...
'class' =>'modal fade',
'size'=>'modal-xl',
'page_title'=>'Accounts Ledger Analysis With Sales Type',
'page_unique_id'=>6,
'godown'=>'yes',
'ledger'=>'yes',
'stockGroup'=>'yes',
'title'=>'Accounts Group Analysis',
'daynamic_function'=>'account_ledger_analysis_with_sales_type_intial_show',
])
@endcomponent
<!-- add component-->
@component('components.report', [
'title' => 'Accounts Ledger Analysis With Sales Type',
'print_layout'=>'landscape',
'print_header'=>'Accounts Ledger Analysis With Sales Type',
...
@slot('header_body')
<form id="add_account_ledger_analysis_with_sales_type" method="POST">
    @csrf
    {{ method_field('POST') }}
    <div class="row ">
        <div class="col-md-4">
...
<script>
    ...
    $(document).ready(function() {
            ...
            if($('.stock_group_id').val()){
                account_ledger_analysis_with_sales_type_intial_show();
           }

        $("#add_account_ledger_analysis_with_sales_type").submit(function(e) {
            ...
            $.ajax({
                url: '{{route("report-account-ledger-analysis-with-sales-type-data") }}',
                method: 'POST',
                data: fd,
                cache: false,
                contentType: false,
                ...
                success: function(response) {
                    $(".modal").hide();
                    account_ledger_analysis_with_sales_type(response);
                },
     ...
     function account_ledger_analysis_with_sales_type(response) {
                    ...
                    if (matchingChild) {
                        ...
                        html.push(`
                            ...
                            ${salse_cash?`
                                ...
                                ${salse_cash_rate?`
                                    <td style='width: 3%;'class="td1 salse_cash_rate_row">
                            ...
                            ${salse_internal?`
                                ...
                                ${salse_internal_rate?`
                                    <td style='width: 3%;'class="td1  salse_internal_rate_row">
            ...
            if (((v.stock_qty_sales_cash_total || 0) == 0) && ((v.stock_qty_sales_credit_total || 0) == 0) && ((v.stock_qty_inter_company_sales_total || 0) == 0) && ((v.stock_total_sales_return_value || 0) == 0)) {} else {
                html.push(`<tr id="${v.stock_item_id}" class="left left-data editIcon table-row">
                        ...
                        ${salse_return?` 
                            ...
                            ${salse_return_rate?`
                                <td style='width: 3%;'class="td2 salse_return_rate_row">
    ...
    function account_ledger_analysis_with_sales_type_intial_show(){
        total_stock_qty_sales_cash = 0;
        total_sales_cash_value = 0;
        total_stock_qty_sales_credit = 0;
        total_sales_credit_value = 0, i = 1, total_stock_qty_inter_company_sales = 0, total_inter_company_sales_value = 0, total_qty_sales_return_total = 0, total_sales_return_value = 0;
