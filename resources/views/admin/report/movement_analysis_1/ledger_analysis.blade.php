...
@component('components.report', [
    ...
    'user_privilege_title'=>'LedgerAnalysis',
    'print_date'=>1,
...
$(document).ready(function () {
    ...
    // ledger  get id check
    if($('ledger_id').val()!=0){
        get_ledger_analysis_initial_show();
    }
    checkbox_check('','');

    $("#ledger_analysis").submit(function(e) {
        local_store_ledger_analysis_set_data();
        $(".modal").show();
        checkbox_check('','')
        print_date();
...
function calculateSumOfChildren(arr) {
 ...
 function get_ledger_analysis_initial_show(){
        local_store_ledger_analysis_get();
       total_inwards_qty=0;total_inwards_value=0; total_outwards_qty=0;total_outwards_value=0;i=1;
        $(".modal").show();
        print_date();
...
function local_store_ledger_analysis_get() {
    ...
    function local_store_ledger_analysis_set_data() {
