...
@section('title','Warehousewise Stock [without Damage Godown]')
@push('css')
<link rel="stylesheet" type="text/css" href="{{asset('libraries/assets/modal-style.css')}}">
<link href="{{asset('common_css/multi-select.css')}}" rel="stylesheet"/>
<style>
...
@component('components.report', [
    'title' => 'Warehousewise Stock [without Damage Godown]',
    'print_layout'=>'landscape',
    'print_header'=>'Warehousewise Stock [without Damage Godown]',
    'user_privilege_title'=>'WarehouseWithoutDamage',
]);
...
<form id="warehouse_form" method="POST">
    ...
    <div class="row ">
        ...
        <div class="col-md-3">
            ...
            <input type="hidden" name="godown_without_damage_id" class="godown_without_damage_id">
            <select id="categories" multiple    class="form-control godown_id" >
...
<script src="{{asset('common_js/jquery.multi-select.js')}}"></script>
<script>
    ...
    $('#categories').change
    (function(){
        $('.godown_without_damage_id').val($(this).val());
    })
</script>
@endpush
@endsection
