...
'id' =>'exampleModal',
'class' =>'modal fade',
'page_title'=>'Stock Item Monthly Summary',
'size'=>'modal-xl',
'page_unique_id'=>14,
'godown'=>'yes',
'stock_item'=>'yes',
...
@component('components.report', [
    ...
    'user_privilege_title'=>'StockItemMonthly',
    ...
    function get_stock_item_monthly_summary_val(response) {
        ...
        response.current_stock.forEach((v, key) => {
            ...
            <td class="td" style="width: 3%;color: #0B55C4;" class="text-wrap date">
                ${stockItemRegisterMonthlyIdWise(v.transaction_date,new Date(v.transaction_date).toLocaleDateString('en-US', { month: 'long', year: 'numeric' }))}
            </td>
        ...
        $('.total_clasing_rate').text((total_clasing_rate||0).formatBangladeshCurrencyType("rate"));
        $('.total_clasing_value').text(((total_clasing_qty*total_clasing_rate)).formatBangladeshCurrencyType("amount"));
        set_scroll_table();
        get_hover();
    }
...
//     url = "{{route('stock-item-register-monthly-id-wise', ['date' =>':date', 'stock_item_id'=>':stock_item_id','godown_id'=>':godown_id','from_date'=>':from_date','to_date'=>':to_date'])}}";
