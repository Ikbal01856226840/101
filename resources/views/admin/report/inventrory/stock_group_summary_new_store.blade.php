...
@section('title','Stock Group Summary Short Store')
@push('css')
<style>
    .th {
...
'id' =>'exampleModal',
'class' =>'modal fade',
'page_title'=>'Stock Group Summary Short Store',
'size'=>'modal-xl',
'page_unique_id'=>17,
'godown'=>'yes',
'stockGroup'=>'yes',
'title'=>'Stock Group Summary Store Short Reports ',
'daynamic_function'=>'get_stock_group_summary_initial_show'
])
@endcomponent
<!-- add component-->
@component('components.report', [
'title' => 'Stock Group Summary Short Store',
'print_layout'=>'portrait',
'print_header'=>'Stock Group Summary Short Store ',
'user_privilege_title'=>'StockGroupSummaryShortStore',
'print_date'=>1,
    ...
    <table id="tableId" style=" border-collapse: collapse; " class="table table-striped customers table-scroll">
        <thead>
            <tr>
                ...
                <th  class="th opening text-end" style=" width: 5%;">Opening Balance</th>
                <th class="th inwards text-end" style=" width: 5%;">Inward Balance</th>
                <th  class="th outwards text-end" style=" width: 5%; ">Outward Balance</th>
                <th  class="th closing text-end" style=" width: 5%;">Closing Balance</th>
            </tr>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#stock_group_summary_form").submit(function(e) {
            ...
            $.ajax({
                url: '{{ route("report-stock-group-summary-short-store-data") }}',
                method: 'POST',
                data: fd,
                cache: false,
                contentType: false,
