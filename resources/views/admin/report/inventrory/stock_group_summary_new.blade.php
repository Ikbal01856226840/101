...
@section('title','Stock Group Summary New')
@push('css')
<style>
    .th {
...
'id' =>'exampleModal',
'class' =>'modal fade',
'page_title'=>'Stock Group Summary Short',
'size'=>'modal-xl',
'page_unique_id'=>53,
'godown'=>'yes',
'stockGroup'=>'yes',
'title'=>'Stock Group Summary Reports Short',
'daynamic_function'=>'get_stock_group_summary_initial_show'
])
@endcomponent
<!-- add component-->
@component('components.report', [
'title' => 'Stock Group Summary Short',
'print_layout'=>'No',
'print_header'=>'Stock Group Summary Short',
'user_privilege_title'=>'StockGroupSummaryNew',
'print_date'=>1,
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#stock_group_summary_form").submit(function(e) {
            ...
            $.ajax({
                url: '{{ route("report-stock-group-summary-data-new") }}',
                method: 'POST',
                data: fd,
                cache: false,
                contentType: false,
