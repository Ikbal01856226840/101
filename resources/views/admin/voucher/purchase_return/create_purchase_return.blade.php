...
<form id="add_purchase_return_id" method="POST">
    ...
    <div align="center">
         @if (user_privileges_check('Voucher',$voucher->voucher_id,'create_role'))
            <button type="submit" class="btn btn-info add_purchase_return_btn" style="width: 116px; border-radius: 15px;">
...
$(document).ready(function(){
   ...
   // form reset
   resetForm("add_purchase_return_id");
      ...
      for(var row=1; row<6;row++) {
          rowCount++;
              $('#orders').append(`<tr  style="margin:0px;padding:0px;" class="p-0 m-0"  id="row${rowCount}">
                  ...
                  <td  class="m-0 p-0">
                      <input class="form-control qty text-right " name="qty[]"  step="any" data-field-name="qty" type="number" step="any"
