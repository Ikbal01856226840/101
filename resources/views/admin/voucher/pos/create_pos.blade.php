            ...
            <table class="table customers" style="border: none !important; margin-top: 5px;">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><input type="number" step="any" name="total_amount" style="border-radius: 15px; font-weight: bold;" class="form-control text-right change_amount" /></td>
                    </tr>
                </tfoot>
                <tfoot>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><input type="text " step="any"  style="border-radius: 15px; font-weight: bold;" class="total_qty form-control text-right" readonly /></td>
                        <td></td>
                        <td></td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><input type="number" step="any" name="total_amount" style="border-radius: 15px; font-weight: bold;" class="total_amount form-control text-right" readonly /></td>
                    </tr>
                </tfoot>
                <tfoot>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td><input type="number" step="any" name="amount_received" style="border-radius: 15px; font-weight: bold;" class="amount_received form-control text-right" /></td>
                    </tr>
                </tfoot>
            </table>
...
function addrow (rowCount)
 {
              ...
              $('#orders').append(`<tr  style="margin:0px;padding:0px;" class="p-0 m-0"  id="row${rowCount}">
                  ...
                  <td  class="m-0 p-0">
                      <input class="form-control rate text-right "  name="rate[]" step="any" data-field-name="rate"
                       type="number" data-type="rate" id="rate_${rowCount}"  for="${rowCount}"  />
                  </td>
  ...
  function calculation_total(){
      ...
      received_amount_submit_disable_enable();
  }
...
function received_amount_submit_disable_enable(){
    let received_amount=$('.amount_received').val();
    let total_qty =$('.total_qty ').val();
    if((received_amount>0)&&(total_qty >0)){
        $(":submit").attr("disabled", false);
    }else{
        $(":submit").attr("disabled", true);
    }
