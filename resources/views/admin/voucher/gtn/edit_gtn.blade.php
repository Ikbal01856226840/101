            ...
            <div class="col-sm-4">
                <div class="row" style="margin-top: 5px;">
                    <div class="col-sm-4 dis" style="float: right;">
                        <label style="float: right; margin: 2px;">Ledger Name :</label><br />
                        <br />
                    ...
                    <div class="col-sm-8 m-0 p-0" style="margin-left: 5px;!important;">
                        ...
                        <input
                            ...
                            id="debit_ledger_id"
                            class="form-control debit_ledger_id"
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <select name="dis_cen_id" class="form-control js-example-basic-single dis_cen_id DistributionCenter " required>
    ...
    <div align="center">
        @if (user_privileges_check('Voucher',$voucher->voucher_id,'alter_role'))
            @if (voucher_modify_authorization($data->tran_id))
                <button type="submit" class="btn btn-info add_received_btn" style="width: 120px; border-radius: 15px;">
...
$('.credit_ledger_id').val('{{$credit->ledger_head_id??0}}');
        ...
        success: function (response) {
            $.each(response.data, function(i,val) {
                ...
                <td  class="m-0 p-0">
                    ...
                    <input class="form-control qty text-right" name="qty[]" step="any"  data-field-name="qty"
                    type="number" class="qty" id="qty_${i}" mainQty="${val.qty}" value="${val.qty}" for="${i}"  />
                </td>
                <td  class="m-0 p-0">
                    <input class="form-control rate text-right"  name="rate[]" step="any" data-field-name="rate"
                    type="number" data-type="rate" id="rate_${i}" value="${val.rate.toFixed(amount_decimals)}"
                ...
                <td  class="m-0 p-0">
                    <input
                    class="form-control amount  text-right" type="number" step="any"  name="amount[]"
                    id="amount_${i}"  value="${val.total.toFixed(amount_decimals)}"
        ...
        for(var row=1; row<6;row++) {
            ...
            $('#orders').append(`<tr  style="margin:0px;padding:0px;" class="p-0 m-0"  id="row${rowCount}">
                <input class="form-control  product_id m-0 p-0"  name="product_id[]" type="hidden" data-type="product_id" id="product_id_${rowCount}"  for="${rowCount}"/>
                    ...
                    <td  class="m-0 p-0">
                        <input class="form-control qty text-right " name="qty[]" step="any"  data-field-name="qty"
                        type="number" class="qty" id="qty_${rowCount}"     for="${rowCount}"  />
                    </td>
                    <td  class="m-0 p-0">
                        <input class="form-control rate text-right "  name="rate[]" step="any" data-field-name="rate"
                        type="number" data-type="rate" id="rate_${rowCount}"  for="${rowCount}" ${stock_item_price_typeabe==0?'readonly':''} />
                    </td>
                    <td  class="m-0 p-0">
    ...
    $(document).ready(function(){
            ...
            if(val.commission_type){
                $('#commission_append').append(`<tr id="${i}">
                    ...
                    <td class="m-0 p-0" >
                        ...
                        value="${val.commission.toFixed(amount_decimals)}" id="commission_amount_${i}" />
                    </td>
        ...
        $('#add_commission').click(function() {
            ...
            $('#commission_append').append(`<tr id="${ComRowCount}">
                ...
                <td class="m-0 p-0" >
                    <input type="number"  step="any"  name="commission_amount[]" class="form-control commission_amount"
                    id="commission_amount_${ComRowCount}" />
                </td>
