        ...
        function addrow(rowCount) {
            ...
            for (var row = 1; row < 6; row++) {
                ...
                $('#orders').append(`<tr  style="margin:0px;padding:0px;" class="p-0 m-0"  id="row${rowCount}">
                                ...
                                <td  class="m-0 p-0">
                                    <input class="form-control qty text-right " name="qty[]" step="any"  data-field-name="qty" type="number"  id="qty_${rowCount}"  for="${rowCount}"  />
                                </td>
                                <td  class="m-0 p-0">
                                ...
                                <td  class="m-0 p-0">
                                    <input class="form-control credit text-right" type="number" name="credit[]" id="credit_${rowCount}"   step="any" for="${rowCount}" readonly/>
                                </td>
