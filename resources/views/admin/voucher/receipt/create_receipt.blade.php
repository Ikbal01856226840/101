                    ...
                    <tr>
                        ...
                        <td>
                            <input
                                ...
                                class="total_dedit form-control text-right"
                                readonly
                            />
                        </td>
                        <td>
                            <input
                                type="text"
                                style="border-radius: 15px; font-weight: bold;"
                                class="total_credit form-control text-right"
                                readonly
                            />
                        </td>
                        <td></td>
    ...
    $(document).ready(function(){
        ...
        $("#orders").on("input", ".display_debit", function () {
            ...
            function addrow (rowCount)
            {
                ...
                $('table tbody tr:first').find('.display_credit').removeAttr('readonly');
                $('table tbody tr:first').find('.display_debit').attr('readonly', true);;
                $('table tbody tr:first').find('.DrCr').val("Cr");
            ...
            if (event.type === 'click' || (event.type === 'keyup' && event.key === 'Tab')) {
                if($(this).val()<=0){
                    if($(this).attr('class').search('credit')>=0 && $(this).closest('tr').find('.DrCr').val()=='Cr'){
                        ...
                        let check_blance=$(this).closest('tr').find('.blance').val().search("Dr");
                        let debit=parseFloat(DrCrCalculation('debit')) || 0;
                        if(debit){
                            if(check_blance==-1){
                                if(debit_credit_amont==0){
