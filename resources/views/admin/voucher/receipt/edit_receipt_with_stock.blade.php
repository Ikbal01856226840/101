             ...
             $.each(response.data, function(i,val) {
                $('#orders').append(`<tr style="margin:0px;padding:0px;" class="p-0 m-0"  id="row${i}">
                                    ...
                                    <td  class="m-0 p-0">
                                        ...
                                        value="${val.in_qty?val.in_qty:val.out_qty}" step="any" class="qty" id="qty_${i}"  for="${i}"  />
                                    ...
                                    <td  class="m-0 p-0">
                                        <input 
                                            ...
                                            step="any"  
                                            name="amount[]"
                                            value="${val.in_total?val.in_total:val.out_total}"  
                                            amount="${val.in_total?val.in_total:val.out_total}" 
                                            id="amount_${i}" ${amount_typeabe==1?'readonly':''}  
                                            for="${i}"
                                        />
                                    </td>
                                    ...
                                    ${(val.debit_credit_id!=debit_credit_check) ?`<td  class="m-0 p-0">
                                        <input 
                                            ...
                                            id="debit_${i}" 
                                            step="any" 
                                            value="${val.debit.toFixed(amount_decimals)}" ${val.dr_cr=="Dr"?'':'readonly'}  
                                            for="${i}"
                                        />
                                    </td>
                                    <td  class="m-0 p-0">
                                        <input class="form-control credit text-right" type="number" name="credit[]" id="credit_${i}"  step="any"  value="${val.credit.toFixed(amount_decimals)}" ${val.dr_cr=="Cr"?'':'readonly'} for="${i}" />
            ...
            function addrow (rowCount)
            {
                    ...
                    for(var row=1; row<6;row++) {
                            ...
                            $('#orders').append(`<tr  style="margin:0px;padding:0px;" class="p-0 m-0"  id="row${rowCount}">
                                ...
                                <td  class="m-0 p-0">
                                    <input class="form-control debit text-right " data-field-name="debit" name="debit[]" type="number"  step="any" 
                                    data-type="debit" id="debit_${rowCount}"  for="${rowCount}"/>
                                </td>
                                <td  class="m-0 p-0">
