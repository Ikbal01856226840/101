            ...
            <table class="table customers" style="border: none !important; margin-top: 5px;">
                <thead>
                    <tr>
                        ...
                        <th class="th col-1.5">Quantity</th>
                        <th class="th col-1.5">Price</th>
    ...
    <div align="center">
        @if (user_privileges_check('Voucher',$voucher->voucher_id,'alter_role'))
            @if (voucher_modify_authorization($data->tran_id))
                <button type="submit" class="btn btn-info edit_purchase_btn cansale_btn" style="width: 120px; border-radius: 15px;">
        ...
        for(var row=1; row<6;row++) {
            rowCount++;
                $('#orders').append(`<tr  style="margin:0px;padding:0px;" class="p-0 m-0"  id="row${rowCount}">
                    ...
                    <td  class="m-0 p-0">
                        <input class="form-control qty text-right " name="qty[]"  data-field-name="qty" type="number"  step="any"  id="qty_${rowCount}"  for="${rowCount}"  />
                    </td>
                    <td  class="m-0 p-0">
                ...
                $('#commission_append').append(`<tr id="${i}">
                    ...
                    <td class="m-0 p-0" >
                        <input type="number" name="commission_amount[]"  step="any"
                            class="form-control commission_amount"
