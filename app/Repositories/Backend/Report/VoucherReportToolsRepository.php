...
class VoucherReportToolsRepository implements VoucherReportToolsInterface
{
    ...
    public function voucherModeChange($request=null){
        return DB::table("transaction_master")->where('tran_id','=',$request->tran_id)->update(['voucher_id'=>$request->voucher_id]);
    }
}
