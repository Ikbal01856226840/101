...
class StockCommissionRepository implements StockCommissionInterface
{
    ...
    public function StoreStockCommission($request)
    {
        ...
        $StockCommission->commission_type = $request->commission_type;
    ...
    public function getStockCommissionData($group_id = null)
    {
        $query = DB::table('stock_group')
            ->select('stock_group_commission.other_details', 'stock_group_commission.user_name', 'stock_group_commission.group_commission_id', 'stock_group.stock_group_id', 'stock_group.stock_group_name', 'stock_group.under', 'stock_group_commission.setup_date', 'stock_group_commission.commission', 'stock_group_commission.commission_type')
        ...
        return $query->orderBy('stock_group.stock_group_name', 'DESC')
            ->orderBy('stock_group_commission.setup_date', 'ASC')
            ->get();
    }
}
