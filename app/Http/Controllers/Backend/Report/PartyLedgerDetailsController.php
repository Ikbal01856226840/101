...
class PartyLedgerDetailsController extends Controller
{
    ...
    public function PartyLedgerInDetailsShowNew()
    {
        if (user_privileges_check('report', 'PartyLedgeDetails', 'display_role')) {
            return view('admin.report.party_ledger.party_ledger_in_details_new');
        } else {
            abort(403);
        }
    ...
    public function PartyLedgerInDetailsGetDataNew(Request $request)
    {
    ...
    {
        if (user_privileges_check('report', 'PartyContactDetails', 'display_role')) {
