...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $sales_orders = $this->voucher->getVoucherOfIndex(20);
        $sales_pos=$this->voucher->getVoucherOfIndex(30);
        $sales_exchanges=$this->voucher->getVoucherOfIndex(27);
        $order_requisitions=$this->voucher->getVoucherOfIndex(11);
        return view('admin.voucher.voucher_dashboard', compact('purchases', 'receives', 'grns', 'sales_return', 'payments', 'sales', 'purchase_returns', 'adjustments', 'contra', 'jv', 'gtns', 'journals', 'commissions','sales_orders','sales_pos','sales_exchanges','order_requisitions'));
    }
}
